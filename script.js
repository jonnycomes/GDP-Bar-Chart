...
const dataset = dataObject.data;



const zoomFactor = 4;
const w = 200 * zoomFactor;
...
svg.selectAll("rect")
       ...
       .enter()
       .append("rect")
       .attr("x", (d, i) => xScale(parseTime(d[0]))) //xScale(parseInt(d[0].slice(0,4))))
       ...
       .on("mouseover", function(d) {       
            ...
            div .attr("data-date", d3.select(this).attr("data-date"))
                ...
                .html("Date: " + d3.select(this).attr("data-date") 
                               + "<br/>"  + 
